  ...
  return (
    <div className="px-5 sm:px-10 md:px-32 lg:px-56 xl:px-72 mt-10">
      ...
      <p className="mt-3 text-gray-500 text-base sm:text-xl">
        Tell us your destination, trip duration, budget, and travel companions
      ...
      <div className="mt-12 flex flex-col gap-9">
        ...
        {/* Traveller */}
        <div>
          <h2 className="text-lg sm:text-xl my-4 font-medium">
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              <img
                src="/new.svg"
                alt="App Logo"
                className="mx-auto h-[40px] mb-4"
              />
              <h2 className="text-2xl font-bold mt-4 text-center">
                Sign in with Google
              </h2>
              <p className="text-center text-gray-600">
                Sign in securely to access personalized trips
              </p>
              <Button
                disabled={loading}
                onClick={login}
